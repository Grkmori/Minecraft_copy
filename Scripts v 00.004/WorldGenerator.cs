...
namespace BlueBird.World {
    public sealed class WorldGenerator {
        ...
        public void CreateWorldDictionaries() {
            ...
            WorldData.dictionaryDynamicEntitiesPrefabs = new ConcurrentDictionary<string, GameObject>();
        ...
        public void ClearWorldDictionaries() {
            ...
            WorldData.dictionaryDynamicEntitiesPrefabs.Clear();
        ...
        public void GenerateStaticEntities() {
            ...
            foreach(Vector2 chunk2DPosition in worldChunks) {
                ...
                ChunkGenerator.queuePopulateListWalkableVoxels.Enqueue(chunkData);
            ...
            if(Settings_str.enableThreading) {
                if(WorldDirector.activeThreads < Settings_str.maxThreads) {
                    ...
                    Debug.LogWarning("<b>maxThreads Limit</b> has been <color=orange><i>reached</i></color>. Couldnt <b><color=yellow><i>Start</i></color> a new Thread</b>. Threading is <color=cyan><i>disabled</i></color> in <b>WorldGenerator</b>.");
                    Settings_str.enableThreading = false;
                }
            } else {
                _chunkGenerator.PopulateListWalkableVoxels();
        ...
        private void ThreadedGeneration() {
            while(Settings_str.enableThreading) {
                ...
                if(ChunkGenerator.queuePopulateListWalkableVoxels.Count == 0 && ChunkGenerator.completePopulateListWalkableVoxels &&
