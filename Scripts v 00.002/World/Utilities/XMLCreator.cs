...
namespace BlueBird.World.Utilities {
    public sealed class XMLCreator {
        ...
        public void SerializeBiomeDefinition() {
            ...
            @stream.Close();
            Debug.Log("<b>BiomeDefintion XMLfile</b> was successful <color=green><i>created</i></color>.");
        }
        ...
        public void SerializeBiomeLodeDefinition() {
            ...
            @stream.Close();
            Debug.Log("<b>BiomeLodeDefintion XMLfile</b> was successful <color=green><i>created</i></color>.");
        }
    }
}