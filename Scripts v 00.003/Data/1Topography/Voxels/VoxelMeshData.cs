...
namespace BlueBird.World.Data.Topography.Voxels {
    public sealed class VoxelMeshData {
		...
		private static readonly float voxelWidthOffSet = Constants_str.voxelSize.x;
		private static readonly float voxelHeightOffSet = Constants_str.voxelSize.y;
		private static readonly float halfvoxelWidthOffSet = Constants_str.voxelSize.x / 2;
		private static readonly float halfvoxelHeightOffSet = Constants_str.voxelSize.y / 2;
		...
		public readonly Vector3[] outChunkFaceChecks = new Vector3[4] {
			new Vector3(0.0f, 0.0f, -voxelWidthOffSet), // South Face
			new Vector3(0.0f, 0.0f, +voxelWidthOffSet), // North Face
			new Vector3(-voxelWidthOffSet, 0.0f, 0.0f), // West Face
			new Vector3(+voxelWidthOffSet, 0.0f, 0.0f) // East Face
