...
namespace BlueBird.World.Player.UI {
    public sealed class PlayerToolbar : MonoBehaviour {
        ...
        private void OnEnable() {
            PlayerInputHandler.eventOnInputMouseAxisScrollWheel += InputMouseScrollWheel;
        }

        private void Start() {
            // Setting up
            playerCanvasTransform = PlayerData.dictionaryPlayerUIObject["CharacterCanvas"].transform;
        ...
        private void InputMouseScrollWheel() {
