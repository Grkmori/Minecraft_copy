    ...
    public sealed class XMLLoader {
        ...
        public void DeserializeVoxelDefinition() {
            ...
            for(int index = 0; index < voxelDefinitionContainer.listVoxelsDefinitions.Count; index++) {
                ...
                bool tryAddFalse = WorldMapData.dictionaryVoxelDefinition.TryAdd(voxelType, voxelDefinitionContainer.listVoxelsDefinitions[index]);
                if(!tryAddFalse) {
                    Debug.LogError("<b>VoxelDefinition</b> <color=red><i>failed to add</i></color> to <b>dictionaryVoxelDefinition</b>.");
                }
            }
            if(WorldMapData.dictionaryVoxelDefinition.Count < voxelDefinitionContainer.listVoxelsDefinitions.Count) {
                Debug.LogWarning("<b>dictionaryVoxelDefinition</b> had some problems and <color=yellow><i>was not fully populated</i></color>.");
            } else {
                Debug.Log("<b>dictionaryVoxelDefinition</b> was <color=green><i>generated</i></color> and <color=cyan><i>populated</i></color> with a total of <i>" + WorldMapData.dictionaryVoxelDefinition.Count + " VoxelDefinitions</i>.");
            }
        }
        ...
        public void DeserializeBiomeDefinition() {
            ...
            for(int index = 0; index < biomeDefinitionContainer.listBiomesDefinitions.Count; index++) {
                ...
                bool tryAddFalse = WorldMapData.dictionaryBiomeDefinition.TryAdd(biomeType, biomeDefinitionContainer.listBiomesDefinitions[index]);
                if(!tryAddFalse) {
                    Debug.LogError("<b>BiomeDefinition</b> <color=red><i>failed to add</i></color> to <b>dictionaryBiomeDefinition</b>.");
                }
            }
            if(WorldMapData.dictionaryBiomeDefinition.Count < biomeDefinitionContainer.listBiomesDefinitions.Count) {
                Debug.LogWarning("<b>dictionaryBiomeDefinition</b> had some problems and <color=yellow><i>was not fully populated</i></color>.");
            } else {
                Debug.Log("<b>dictionaryBiomeDefinition</b> was <color=green><i>generated</i></color> and <color=cyan><i>populated</i></color> with a total of <i>" + WorldMapData.dictionaryBiomeDefinition.Count + " BiomeDefinitions</i>.");
            }
        }
        ...
        public void DeserializeBiomeLodeDefinition() {
            ...
            for(int index = 0; index < biomeLodeDefinitionContainer.listBiomeLodesDefinitions.Count; index++) {
                ...
                bool tryAddFalse = WorldMapData.dictionaryBiomeLodeDefinition.TryAdd(biomeLodeType, biomeLodeDefinitionContainer.listBiomeLodesDefinitions[index]);
                if(!tryAddFalse) {
                    Debug.LogError("<b>BiomeLodeDefinition</b> <color=red><i>failed to add</i></color> to <b>dictionaryBiomeLodeDefinition</b>.");
                }
            }
            if(WorldMapData.dictionaryBiomeLodeDefinition.Count < biomeLodeDefinitionContainer.listBiomeLodesDefinitions.Count) {
                Debug.LogWarning("<b>dictionaryBiomeLodeDefinition</b> had some problems and <color=yellow><i>was not fully populated</i></color>.");
            } else {
                Debug.Log("<b>dictionaryBiomeLodeDefinition</b> was <color=green><i>generated</i></color> and <color=cyan><i>populated</i></color> with a total of <i>" + WorldMapData.dictionaryBiomeLodeDefinition.Count + " BiomeLodeDefinitions</i>.");
            }
        }
