...
namespace BlueBird.World.WorldMap.Topography.Chunks {
    public sealed class ChunkUtilities {
        ...
        private readonly float chunkCorrection = 0.01f; // Used to get the right Chunk when rounding .5;
        ...
        public Chunk CheckForCurrentChunk(Vector3 characterPosition, Chunk currentChunk) {
            ...
            if(currentChunk.chunkPosition != characterChunkPosition) {
                if(WorldMapData.dictionaryChunkData.ContainsKey(characterChunkPosition)) {
