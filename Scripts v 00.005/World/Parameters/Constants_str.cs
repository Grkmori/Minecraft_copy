...
namespace BlueBird.World.Parameters {
    public struct Constants_str {
        ...
        public const float viewDistanceChunk = 3;
        ...
        public static readonly Vector3 topVoxelPosition = new Vector3(0, +voxelSize.y, 0);
        public static readonly Vector3 bottomVoxelPosition = new Vector3(0, -voxelSize.y, 0);
        ...
        public const int pathfinderMaxSize = 4112;
        public const float baseVoxelMovementCost = 1f;
        public const float moveStraitCost = 1f;
        public const float moveDiagonalCost = 1.4f;
        public const float moveVerticalCost = 0.6f;
    }
}