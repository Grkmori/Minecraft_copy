...
namespace BlueBird.World.Utilities {
    public sealed class SpriteAtlasCreator {
        private string spriteAtlasDestinationFolder = Application.dataPath + "/Resources/SpriteAtlas";
        private string spriteSourceFolder = Application.dataPath + "/Resources/SpriteAtlas";
        ...
        public void CreateAtlasesFolder() {
            ...
            foreach(DirectoryInfo @rootSubFolder in @rootFolder.GetDirectories()) {
                ...
                Debug.Log("<b>" + @spriteAtlas.name + "</b> has been <color=green><i>created</i></color>, with a total of <i>" + @spriteAtlas.spriteCount + "</i> sprites."); // TODO: Verify why spriteCount is not working
            }
        }
